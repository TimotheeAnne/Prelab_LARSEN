...
def compare(config):
    ...
    with open("./data/train_data_"+config['data_size']+".pk", 'rb') as f:
        data = pickle.load(f)
    with open("./data/train_eval_"+config['data_size']+".pk", 'rb') as f:
        train_in, train_out = pickle.load(f)
    with open("./data/test_eval_"+config['data_size']+".pk", 'rb') as f:
